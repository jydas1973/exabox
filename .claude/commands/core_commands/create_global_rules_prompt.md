...
**IMPORTANT**: First, determine which CLI environment you are running in:
- If you are **Claude Code CLI**: Create a file named `CLAUDE.md`
- If you are **Codex CLI** (or any other CLI): Create a file named `AGENTS.md`

Use this filename consistently throughout the process.

## Instructions for Creating Global Rules

Create your global rules file (CLAUDE.md or AGENTS.md based on the CLI detected above) following this structure:
...
Create the global rules file (CLAUDE.md or AGENTS.md) with:
...
Start by determining which CLI you are running in (Claude Code or Codex), then analyze the project structure. If this is a new project and you need more information, ask your clarifying questions first.
