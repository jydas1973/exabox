...
First, check if a requirements document exists at: `.agents/features/$ARGUMENTS-requirements.md`

**If requirements document EXISTS:**

- Read the entire requirements document
- Extract all information:
  - Feature overview and problem statement
  - User story (already formatted)
  ...
  - Success metrics
  - Open questions
- Use this as the PRIMARY source of truth for requirements
- Note any open questions that need resolution during planning
- Skip to Phase 2 (Codebase Intelligence Gathering)

**If requirements document DOES NOT EXIST:**

Perform deep feature analysis by extracting from conversation context:
...
- Check CLAUDE.md or AGENTS.md (whichever is present) for project-specific rules and conventions
...
**NOTE**: If you read a requirements document in Phase 1, use that information to populate the Feature Description, User Story, Problem Statement, and acceptance criteria sections. The requirements document is the source of truth for WHAT to build; your plan defines HOW to build it.

```markdown
# Feature: <feature-name>

**Requirements Source**: [Link to requirements doc if it exists, otherwise "Conversation context"]
...
<If requirements doc exists, use the Overview section>
...
<If requirements doc exists, use the User Story section verbatim>

## Problem Statement

<Clearly define the specific problem or opportunity this feature addresses>
<If requirements doc exists, use the Problem Statement section>

## Solution Statement

<Describe the proposed solution approach and how it solves the problem>
<This is YOUR analysis based on codebase research and technical planning>
...
<If requirements doc exists, incorporate the acceptance criteria from there>

Feature-Specific Criteria:
- [ ] <Criterion from requirements doc or analysis>
- [ ] <Criterion from requirements doc or analysis>
- [ ] <Criterion from requirements doc or analysis>
