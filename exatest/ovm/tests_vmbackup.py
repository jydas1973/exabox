        ...
        _cmds = {
            self.mGetRegexDom0(): [
                [
                    ...
                    exaMockCommand("rm -rf /opt/exacloud/vmbackup/python-runtime-stage",aRc=0, aPersist=True),
                    exaMockCommand("rm -rf /opt/python-vmbackup.new",aRc=0, aPersist=True),
                    exaMockCommand("rm -rf /opt/python-vmbackup.old",aRc=0, aPersist=True),
                    exaMockCommand("mkdir -p /opt/exacloud/vmbackup/python-runtime-stage",aRc=0, aPersist=True),
                    exaMockCommand("tar -xzf /opt/exacloud/vmbackup/python-for-vmbackup.tgz -C /opt/exacloud/vmbackup/python-runtime-stage",aRc=0, aPersist=True),
                    exaMockCommand("/bin/test -e /opt/exacloud/vmbackup/python-runtime-stage/opt/python-vmbackup",aRc=0, aPersist=True),
                    exaMockCommand("mv /opt/exacloud/vmbackup/python-runtime-stage/opt/python-vmbackup /opt/python-vmbackup.new",aRc=0, aPersist=True),
                    exaMockCommand("/bin/test -e /opt/python-vmbackup",aRc=0, aPersist=True),
                    exaMockCommand("mv /opt/python-vmbackup /opt/python-vmbackup.old",aRc=0, aPersist=True),
                    exaMockCommand("mv /opt/python-vmbackup.new /opt/python-vmbackup",aRc=0, aPersist=True),
                    ...
                    exaMockCommand("/bin/test -e /opt/exacloud/vmbackup/python-for-vmbackup.tgz",aRc=0, aPersist=True),
                    exaMockCommand("rm -f /opt/exacloud/vmbackup/python-for-vmbackup.tgz",aRc=0, aPersist=True),
        ...
        _cmds = {
            self.mGetRegexDom0(): [
                [
                    ...
                    exaMockCommand("tar -xzf /opt/exacloud/vmbackup/release-vmbackup.tgz*",aRc=0, aPersist=True),
                    exaMockCommand("cd /opt/exacloud/vmbackup/release-vmbackup*",aRc=0, aPersist=True),
                    exaMockCommand("/bin/test -e /opt/python-vmbackup.old",aRc=0, aPersist=True),
                    exaMockCommand("rm -rf /opt/python-vmbackup",aRc=0, aPersist=True),
                    exaMockCommand("mv /opt/python-vmbackup.old /opt/python-vmbackup",aRc=0, aPersist=True),
                ],
                [
                    exaMockCommand("if [[ ! `find ~/.ssh -maxdepth 1 -name 'id_rsa'` || ! `find ~/.ssh -maxdepth 1 -name 'id_rsa.pub'` ]]*",aRc=0, aStdout="aaaasdasdafasfafa",aPersist=True),
                    exaMockCommand("sed --follow-symlinks -i*",aRc=0, aPersist=True),
