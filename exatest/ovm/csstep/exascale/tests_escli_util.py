...
class ebTestEscliUtil(ebTestClucontrol):
    ...
    def test_mGetUser(self):
        ...
        _cmds = {self.mGetRegexCell(): [[exaMockCommand('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 --json lsuser', aRc=0, aStdout='{"data":[{"id":"gridiad1046clu040a1"}]}', aPersist=True)]]}
    ...
    def test_mGetEDVInitiator(self):
        ...
        _options = copy.deepcopy(self.mGetClubox().mGetArgsOptions())
        _options.jsonconf = json.loads(EXASCALE_PAYLOAD)
        _cmds = {self.mGetRegexCell(): [[exaMockCommand('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 --json lsinitiator --attributes id,hostName', aRc=0, aStdout='{"data":[{"id":"a3311f85-8414-ac62-a331-1f858414ac62","attributes":{"hostName":"scaqab10adm01"}}]}', aPersist=True)]]}
        self.mPrepareMockCommands(_cmds)
        _escli = ebEscliUtils(_ebox)
    ...
    def test_mGetClusterID(self):
        ...
        _options = copy.deepcopy(self.mGetClubox().mGetArgsOptions())
        _options.jsonconf = json.loads(EXASCALE_PAYLOAD)
        _cmds = {self.mGetRegexCell(): [[exaMockCommand('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 --json lsinitiator --attributes giClusterName,giClusterId', aRc=0, aStdout='{"data":[{"attributes":{"giClusterName":"club086e35-128","giClusterId":"9e827518-8a9f-5fd9-ffbe-c2ae1c46734c"}}]}', aPersist=True)], [exaMockCommand('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 --json lsuser', aRc=0, aStdout='{"data":[{"id":"gridclub086e35-128"}]}', aPersist=True)]]}
        self.mPrepareMockCommands(_cmds)
        _escli = ebEscliUtils(_ebox)
        ...
        _options = copy.deepcopy(self.mGetClubox().mGetArgsOptions())
        _options.jsonconf = json.loads(EXASCALE_PAYLOAD)
        _cmds = {self.mGetRegexCell(): [[exaMockCommand('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 --json lsvolume --attributes id,vault,name,owners', aRc=0, aStdout='{"data":[{"id":"2:b4d00303b12f46d6a31b4a5339395cd3","attributes":{"vault":"@vault1clu02","name":"acfs_gridclub086e35-128","owners":"admin"}}]}', aPersist=True)]]}
        self.mPrepareMockCommands(_cmds)
        _escli = ebEscliUtils(_ebox)
    ...
    def test_mGetVolumeAttachments(self):
        ...
        _options = copy.deepcopy(self.mGetClubox().mGetArgsOptions())
        _options.jsonconf = json.loads(EXASCALE_PAYLOAD)
        _cmds = {self.mGetRegexCell(): [[exaMockCommand('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 --json lsvolumeattachment --attributes id,volume,deviceName', aRc=0, aStdout='{"data":[{"id":"3:175ebf661f8e49c09d03f8214f6c5b39","attributes":{"volume":"2:b4d00303b12f46d6a31b4a5339395cd3","deviceName":"xacfsvol"}}]}', aPersist=True)]]}
        self.mPrepareMockCommands(_cmds)
        _escli = ebEscliUtils(_ebox)
    ...
    def test_mGetACFSFileSystemByJsonFormat(self):
        ...
        _options = copy.deepcopy(self.mGetClubox().mGetArgsOptions())
        _options.jsonconf = json.loads(EXASCALE_PAYLOAD)
        _cmds = {self.mGetRegexCell(): [[exaMockCommand('/bin/test -e *', aRc=0, aStdout='', aPersist=True), exaMockCommand('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 --json lsacfsfilesystem --attributes id,volume,mountPath,size,totalFree', aRc=0, aStdout='{"data":[{"attributes":{"id":"1","volume":"vol_1","mountPath":"/acfs","size":10737418240,"totalFree":5368709120}}]}', aPersist=True)]]}
        self.mPrepareMockCommands(_cmds)
        _escli = ebEscliUtils(_ebox)
    ...
    def test_mChangeACL(self):
        ...
        _options = copy.deepcopy(self.mGetClubox().mGetArgsOptions())
        _options.jsonconf = json.loads(EXASCALE_PAYLOAD)
        _cmds = {self.mGetRegexCell(): [[exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 chacl @vault1clu02 +club086e35-128:none'), aRc=0, aPersist=True)]]}
        self.mPrepareMockCommands(_cmds)
        _escli = ebEscliUtils(_ebox)
    ...
    def test_mCreateEDVVolumeP01(self):
        ...
        _options = copy.deepcopy(self.mGetClubox().mGetArgsOptions())
        _options.jsonconf = json.loads(EXASCALE_PAYLOAD)
        _cmds = {self.mGetRegexCell(): [[exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 mkvolume 200GB --vault vault1clu02 --attributes name=acfs_gridclub086e35-128'), aRc=0, aPersist=True)]]}
        self.mPrepareMockCommands(_cmds)
        _escli = ebEscliUtils(_ebox)
    ...
    def test_mCreateEDVVolumeP02(self):
        ...
        _options = copy.deepcopy(self.mGetClubox().mGetArgsOptions())
        _options.jsonconf = json.loads(EXASCALE_PAYLOAD)
        _cmds = {self.mGetRegexCell(): [[exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 mkvolume 200GB --vault image --attributes name=c3716n15c2_u01'), aRc=0, aPersist=True)]]}
        self.mPrepareMockCommands(_cmds)
        _escli = ebEscliUtils(_ebox)
    ...
    def test_mCreateEDVVolumeAttachmentP01(self):
        ...
        _options = copy.deepcopy(self.mGetClubox().mGetArgsOptions())
        _options.jsonconf = json.loads(EXASCALE_PAYLOAD)
        _cmds = {self.mGetRegexCell(): [[exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 mkvolumeattachment --protocol edv 2:2fad5a43ed1f46be8eb3687ba59b1d00 xacfsvol --attributes giClusterId=9e827518-8a9f-5fd9-ffbe-c2ae1c46734c,user=gridclub086e35-128'), aRc=0, aPersist=True)]]}
        self.mPrepareMockCommands(_cmds)
        _escli = ebEscliUtils(_ebox)
    ...
    def test_mCreateEDVVolumeAttachmentP02(self):
        ...
        _options = copy.deepcopy(self.mGetClubox().mGetArgsOptions())
        _options.jsonconf = json.loads(EXASCALE_PAYLOAD)
        _cmds = {self.mGetRegexCell(): [[exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 mkvolumeattachment --protocol edv 2:2fad5a43ed1f46be8eb3687ba59b1d00 xacfsvol --initiator a3311f85-8414-ac62-a331-1f858414ac62 --attributes user=gridclub086e35-128'), aRc=0, aPersist=True)]]}
        self.mPrepareMockCommands(_cmds)
        _escli = ebEscliUtils(_ebox)
    ...
    def test_mCreateACFSFileSystem(self):
        ...
        _options = copy.deepcopy(self.mGetClubox().mGetArgsOptions())
        _options.jsonconf = json.loads(EXASCALE_PAYLOAD)
        _cmds = {self.mGetRegexCell(): [[exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 mkacfsfilesystem 2:2fad5a43ed1f46be8eb3687ba59b1d00 /var/opt/oracle/dbaas_acfs --attributes name=default_acfs,user=gridclub086e35-128,mountLeafOwner=1001,mountLeafGroup=1001,mountLeafMode=0755'), aRc=0, aPersist=True)]]}
        self.mPrepareMockCommands(_cmds)
        _escli = ebEscliUtils(_ebox)
    ...
    def test_mChangeVolume(self):
        ...
        _options = copy.deepcopy(self.mGetClubox().mGetArgsOptions())
        _options.jsonconf = json.loads(EXASCALE_PAYLOAD)
        _cmds = {self.mGetRegexCell(): [[exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 chvolume 2:2fad5a43ed1f46be8eb3687ba59b1d00 --attributes owners=+gridclub086e35-128'), aRc=0, aPersist=True)]]}
        self.mPrepareMockCommands(_cmds)
        _escli = ebEscliUtils(_ebox)
    ...
    def test_mMountACFSFileSystem(self):
        ...
        _options = copy.deepcopy(self.mGetClubox().mGetArgsOptions())
        _options.jsonconf = json.loads(EXASCALE_PAYLOAD)
        _cmds = {self.mGetRegexCell(): [[exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 acfsctl register 2:2fad5a43ed1f46be8eb3687ba59b1d00 /acfs_1 --attributes mountLeafOwner=1001,mountLeafGroup=1001,mountLeafMode=0755,user=gridclub086e35-128'), aRc=0, aPersist=True)]]}
        self.mPrepareMockCommands(_cmds)
        _escli = ebEscliUtils(_ebox)
    ...
    def test_mUnMountACFSFileSystem(self):
        ...
        _options = copy.deepcopy(self.mGetClubox().mGetArgsOptions())
        _options.jsonconf = json.loads(EXASCALE_PAYLOAD)
        _cmds = {self.mGetRegexCell(): [[exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 acfsctl deregister 1:6cafd8310b3d49a2becd17e9c08f7919'), aRc=0, aPersist=True)]]}
        self.mPrepareMockCommands(_cmds)
        _escli = ebEscliUtils(_ebox)
    ...
    def test_mRemoveACFSFileSystem(self):
        ...
        _options = copy.deepcopy(self.mGetClubox().mGetArgsOptions())
        _options.jsonconf = json.loads(EXASCALE_PAYLOAD)
        _cmds = {self.mGetRegexCell(): [[exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 rmacfsfilesystem 1:6cafd8310b3d49a2becd17e9c08f7919'), aRc=0, aPersist=True)]]}
        self.mPrepareMockCommands(_cmds)
        _escli = ebEscliUtils(_ebox)
    ...
    def test_mRemoveEDVAttachment(self):
        ...
        _options = copy.deepcopy(self.mGetClubox().mGetArgsOptions())
        _options.jsonconf = json.loads(EXASCALE_PAYLOAD)
        _cmds = {self.mGetRegexCell(): [[exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 rmvolumeattachment 3:175ebf661f8e49c09d03f8214f6c5b39'), aRc=0, aPersist=True)], [exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 rmvolumeattachment 3:175ebf661f8e49c09d03f8214f6c5b39 --force'), aRc=0, aPersist=True)]]}
        self.mPrepareMockCommands(_cmds)
        _escli = ebEscliUtils(_ebox)
    ...
    def test_mRemoveEDVVolume(self):
        ...
        _options = copy.deepcopy(self.mGetClubox().mGetArgsOptions())
        _options.jsonconf = json.loads(EXASCALE_PAYLOAD)
        _cmds = {self.mGetRegexCell(): [[exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 rmvolume 2:b4d00303b12f46d6a31b4a5339395cd3'), aRc=0, aPersist=True)]]}
        self.mPrepareMockCommands(_cmds)
        _escli = ebEscliUtils(_ebox)
    ...
    def test_mRemoveFile(self):
        ...
        _options = copy.deepcopy(self.mGetClubox().mGetArgsOptions())
        _options.jsonconf = json.loads(EXASCALE_PAYLOAD)
        _cmds = {self.mGetRegexCell(): [[exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 rmfile @vault1clu02/CLUB086e35-128* '), aRc=0, aPersist=True)], [exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 rmfile @vault1clu02/CLUB086e35-128* --force'), aRc=0, aPersist=True)]]}
        self.mPrepareMockCommands(_cmds)
        _escli = ebEscliUtils(_ebox)
    ...
    def test_mCreateVault(self):
        ...
        _cmds = {self.mGetRegexCell(): [[exaMockCommand(re.escape('/bin/test -e /opt/oracle/cell/cellsrv/bin/escli'), aRc=0, aPersist=True), exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 --json mkvault @vault1clu02 --provision-space-ef 10G'), aRc=0, aPersist=True)], [exaMockCommand(re.escape('/bin/test -e /opt/oracle/cell/cellsrv/bin/escli'), aRc=0, aPersist=True), exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 --json mkvault @vault1clu02 --provision-space-hc 10G'), aRc=0, aPersist=True)]]}
        self.mPrepareMockCommands(_cmds)
        _escli = ebEscliUtils(_ebox)
    ...
    def test_mListVault(self):
        ...
        _options = copy.deepcopy(self.mGetClubox().mGetArgsOptions())
        _options.jsonconf = json.loads(VAULT_PAYLOAD)
        _cmds = {self.mGetRegexCell(): [[exaMockCommand(re.escape('/bin/test -e /opt/oracle/cell/cellsrv/bin/escli'), aRc=0, aPersist=True), exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 lsvault @vault1clu02 --attributes spaceUsedHC'), aRc=0, aPersist=True)], [exaMockCommand(re.escape('/bin/test -e /opt/oracle/cell/cellsrv/bin/escli'), aRc=0, aPersist=True), exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 --json lsvault @vault1clu02 --detail'), aRc=0, aPersist=True)], [exaMockCommand(re.escape('/bin/test -e /opt/oracle/cell/cellsrv/bin/escli'), aRc=0, aPersist=True), exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 lsvault @vault1clu02'), aRc=0, aPersist=True)]]}
        self.mPrepareMockCommands(_cmds)
    ...
    def test_mChangeVault(self):
        ...
        _options = copy.deepcopy(self.mGetClubox().mGetArgsOptions())
        _options.jsonconf = json.loads(VAULT_PAYLOAD)
        _cmds = {self.mGetRegexCell(): [[exaMockCommand(re.escape('/bin/test -e /opt/oracle/cell/cellsrv/bin/escli'), aRc=0, aPersist=True), exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 --json chvault @vault1clu02 --attributes spaceProvEF=10G'), aRc=0, aPersist=True)], [exaMockCommand(re.escape('/bin/test -e /opt/oracle/cell/cellsrv/bin/escli'), aRc=0, aPersist=True), exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 --json chvault @vault1clu02 --attributes spaceProvHC=10G'), aRc=0, aPersist=True)]]}
        self.mPrepareMockCommands(_cmds)
        _escli = ebEscliUtils(_ebox)
    ...
    def test_mRemoveVault(self):
        ...
        _options = copy.deepcopy(self.mGetClubox().mGetArgsOptions())
        _options.jsonconf = json.loads(VAULT_PAYLOAD)
        _cmds = {self.mGetRegexCell(): [[exaMockCommand(re.escape('/bin/test -e /opt/oracle/cell/cellsrv/bin/escli'), aRc=0, aPersist=True), exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 rmvault @vault1clu02'), aRc=0, aPersist=True)]]}
        self.mPrepareMockCommands(_cmds)
        _escli = ebEscliUtils(_ebox)
    ...
    def test_mGetProvisionedValue(self):
        ...
        _options = copy.deepcopy(self.mGetClubox().mGetArgsOptions())
        _options.jsonconf = json.loads(VAULT_PAYLOAD)
        _cmds = {self.mGetRegexCell(): [[exaMockCommand(re.escape('/bin/test -e /opt/oracle/cell/cellsrv/bin/escli'), aRc=0, aPersist=True), exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 --json  lsvault *xsvlt-* --attributes spaceProvEF'), aRc=0, aPersist=True)], [exaMockCommand(re.escape('/bin/test -e /opt/oracle/cell/cellsrv/bin/escli'), aRc=0, aPersist=True), exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 --json  lsvault *xsvlt-* --attributes spaceProvHC'), aRc=0, aPersist=True)]]}
        self.mPrepareMockCommands(_cmds)
        _escli = ebEscliUtils(_ebox)
    ...
    def test_mListStoragePool(self):
        ...
        _options = copy.deepcopy(self.mGetClubox().mGetArgsOptions())
        _options.jsonconf = json.loads(VAULT_PAYLOAD)
        _cmds = {self.mGetRegexCell(): [[exaMockCommand(re.escape('/bin/test -e /opt/oracle/cell/cellsrv/bin/escli'), aRc=0, aPersist=True), exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 --json  lsstoragepool hcpool --attributes spaceRaw,spaceProvisioned,spaceUsed'), aRc=0, aPersist=True)]]}
        self.mPrepareMockCommands(_cmds)
        _escli = ebEscliUtils(_ebox)
    ...
    def test_mCurrentStoragePoolSize(self):
        ...
        _options = copy.deepcopy(self.mGetClubox().mGetArgsOptions())
        _options.jsonconf = json.loads(VAULT_PAYLOAD)
        _cmds = {self.mGetRegexCell(): [[exaMockCommand(re.escape('/bin/test -e /opt/oracle/cell/cellsrv/bin/escli'), aRc=0, aPersist=True), exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 --json  lsstoragepool hcpool --attributes spaceProvisionable,spaceProvisioned,spaceUsed'), aRc=0, aPersist=True)]]}
        self.mPrepareMockCommands(_cmds)
        _escli = ebEscliUtils(_ebox)
    ...
    def test_mReconfigStoragePool(self):
        ...
        _options = copy.deepcopy(self.mGetClubox().mGetArgsOptions())
        _options.jsonconf = json.loads(VAULT_PAYLOAD)
        _cmds = {self.mGetRegexCell(): [[exaMockCommand(re.escape('/bin/test -e /opt/oracle/cell/cellsrv/bin/escli'), aRc=0, aPersist=True), exaMockCommand(re.escape('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.130.110:5052 chstoragepool hcpool --reconfig --force'), aRc=0, aPersist=True)]]}
        self.mPrepareMockCommands(_cmds)
        _escli = ebEscliUtils(_ebox)
    ...
    def test_mCreateEsWalletUser_updates_pubkey_and_acl(self):
        ...
        _cell_list = _ebox.mReturnCellNodes()
        _cell = list(_cell_list.keys())[0]
        _options = SimpleNamespace(jsonconf={'exascale': {'ctrl_network': {'ip': '10.0.0.22', 'port': '5052'}}})
        _mk_stdout = mock.MagicMock()
        _mk_stdout.readlines.return_value = []
        _lsacl_stdout = mock.MagicMock()
        _lsacl_stdout.readlines.return_value = [json.dumps({'data': {'attributes': {'acl': 'existing:I'}}})]
        _mock_node = mock.MagicMock()
        _mock_node.mFileExists.return_value = True
        _mock_node.mExecuteCmd.side_effect = [(0, _mk_stdout, ''), (0, mock.MagicMock(), ''), (0, mock.MagicMock(), ''), (0, _lsacl_stdout, '')]
        _mock_ctx = mock.MagicMock()
        _mock_ctx.__enter__.return_value = _mock_node
        _mock_ctx.__exit__.return_value = None
        with mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_mock_ctx), mock.patch('exabox.ovm.csstep.exascale.escli_util.node_exec_cmd_check') as _exec_check_mock:
            _escli = ebEscliUtils(_ebox)
            _escli.mCreateEsWalletUser(_options, _cell, 'user02', aPubKeyFile='/tmp/key.pub', aVaultName='vault1')
        ...
        _exec_check_mock.assert_called_once_with(_mock_node, f'{ESCLI} --wallet {WALLET_LOC} --ctrl 10.0.0.22:{CTRL_PORT} chacl vault1 "existing:I;user02:I"')

    def test_mCreateEsWalletUser_acl_already_contains_user(self):
        _ebox = self.mGetClubox()
        _cell_list = _ebox.mReturnCellNodes()
        _cell = list(_cell_list.keys())[0]
        _options = SimpleNamespace(jsonconf={'exascale': {'ctrl_network': {'ip': '10.0.0.23', 'port': '5052'}}})
        _mk_stdout = mock.MagicMock()
        _mk_stdout.readlines.return_value = []
        _lsacl_stdout = mock.MagicMock()
        _lsacl_stdout.readlines.return_value = [json.dumps({'data': {'attributes': {'acl': 'existing:I;user03:I'}}})]
        _mock_node = mock.MagicMock()
        _mock_node.mFileExists.return_value = True
        _mock_node.mExecuteCmd.side_effect = [(0, _mk_stdout, ''), (0, _lsacl_stdout, '')]
        _mock_ctx = mock.MagicMock()
        _mock_ctx.__enter__.return_value = _mock_node
        _mock_ctx.__exit__.return_value = None
        with mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_mock_ctx), mock.patch('exabox.ovm.csstep.exascale.escli_util.node_exec_cmd_check') as _exec_check_mock:
    ...
    def test_mCreateEsWalletUser_acl_missing_output(self):
        ...
        _cell_list = _ebox.mReturnCellNodes()
        _cell = list(_cell_list.keys())[0]
        _options = SimpleNamespace(jsonconf={'exascale': {'ctrl_network': {'ip': '10.0.0.24', 'port': '5052'}}})
        _mk_stdout = mock.MagicMock()
        _mk_stdout.readlines.return_value = []
        _lsacl_stdout = mock.MagicMock()
        _lsacl_stdout.readlines.return_value = [json.dumps({'data': {'attributes': {'acl': None}}})]
        _mock_node = mock.MagicMock()
        _mock_node.mFileExists.return_value = True
        _mock_node.mExecuteCmd.side_effect = [(0, _mk_stdout, ''), (0, _lsacl_stdout, '')]
        _mock_ctx = mock.MagicMock()
    ...
    def test_mListFiles(self):
        ...
        with mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_mock_ctx), mock.patch('exabox.ovm.csstep.exascale.escli_util.node_exec_cmd', return_value=(0, 'file1\nfile2\n', '')):
            _escli = ebEscliUtils(_ebox)
    ...
    def test_mUpdateRequestData_updates_request(self):
        ...
        self.assertEqual(json.loads(_stored_json), {'success': 'False', 'error': _error, 'output': _payload})
    ...
    def test_mExecuteEscliCmd_missing_escli(self):
        ...
        _cell_list = _ebox.mReturnCellNodes()
        _cell = list(_cell_list.keys())[0]
        _cmds = {self.mGetRegexCell(): [[exaMockCommand(re.escape('/bin/test -e /opt/oracle/cell/cellsrv/bin/escli'), aRc=1, aPersist=True)]]}
        self.mPrepareMockCommands(_cmds)
        _escli = ebEscliUtils(_ebox)
        with self.assertRaises(ExacloudRuntimeError):
    ...
    def test_mRemoveVMUserPrivilege_executes(self):
        _ebox = self.mGetClubox()
        _cell = list(_ebox.mReturnCellNodes().keys())[0]
        _options = SimpleNamespace(jsonconf={'ctrl_network': {'ip': '10.0.1.10', 'port': '5052'}})
        _node = mock.MagicMock()
        _ctx = mock.MagicMock()
        _ctx.__enter__.return_value = _node
        _ctx.__exit__.return_value = None
        with mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_ctx):
            _escli = ebEscliUtils(_ebox)
            _escli.mRemoveVMUserPrivilege(_cell, 'gridCluster01', _options)
        _node.mExecuteCmdLog.assert_called_once_with('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.1.10:5052 chuser gridCluster01 --attributes privilege="no_privilege"')

    def test_mRemoveVMUserPrivilege_fallback_ctrl(self):
        _ebox = self.mGetClubox()
        _cell = list(_ebox.mReturnCellNodes().keys())[0]
        _options = SimpleNamespace(jsonconf=None)
        _node = mock.MagicMock()
        ...
        _ctx.__enter__.return_value = _node
        _ctx.__exit__.return_value = None
        with mock.patch.object(ebEscliUtils, 'mParseExascaleAttrib', side_effect=Exception('oops')), mock.patch.object(ebEscliUtils, 'mGetCtrlIP', return_value=('10.0.2.10', 'fallback')), mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_ctx):
            _escli = ebEscliUtils(_ebox)
            _escli.mRemoveVMUserPrivilege(_cell, 'oracleCluster01', _options)
        _node.mExecuteCmdLog.assert_called_once_with('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.2.10:5052 chuser oracleCluster01 --attributes privilege="no_privilege"')

    def test_mChangeClusterAtributes_success(self):
        _ebox = self.mGetClubox()
        _cell = list(_ebox.mReturnCellNodes().keys())[0]
        _options = SimpleNamespace(jsonconf={'ctrl_network': {'ip': '10.0.3.10', 'port': '5052'}})
        _node = mock.MagicMock()
        ...
        with mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_ctx):
            _escli = ebEscliUtils(_ebox)
            _rc = _escli.mChangeClusterAtributes(_cell, _options, {'normalRedundancy': 'false'})
        self.assertEqual(_rc, 0)
        _node.mExecuteCmdLog.assert_called_once_with('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.3.10:5052 chcluster --attributes normalRedundancy=false ')

    def test_mChangeClusterAtributes_error_path(self):
        _ebox = self.mGetClubox()
        _cell = list(_ebox.mReturnCellNodes().keys())[0]
        _options = SimpleNamespace(jsonconf=None)
        _node = mock.MagicMock()
        ...
        _ctx.__enter__.return_value = _node
        _ctx.__exit__.return_value = None
        with mock.patch.object(ebEscliUtils, 'mParseExascaleAttrib', side_effect=Exception('boom')), mock.patch.object(ebEscliUtils, 'mGetCtrlIP', return_value=('10.0.4.10', 'fallback')), mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_ctx):
            _escli = ebEscliUtils(_ebox)
            _rc = _escli.mChangeClusterAtributes(_cell, _options, {'normalRedundancy': 'false'})
        self.assertEqual(_rc, 1)
        _node.mExecuteCmdLog.assert_called_once_with('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.4.10:5052 chcluster --attributes normalRedundancy=false ')

    def test_mListFiles_json_with_filter(self):
        _ebox = self.mGetClubox()
        _cell = list(_ebox.mReturnCellNodes().keys())[0]
        _options = SimpleNamespace(jsonconf={'exascale': {'db_vault': {'name': 'vaultA'}, 'ctrl_network': {'ip': '10.0.5.10', 'port': '5052'}}})
        _stdout = mock.MagicMock()
        _stdout.read.return_value = '{"data": [{"attributes": {"name": "fileX"}}]}'
        _node = mock.MagicMock()
        ...
        with mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_ctx):
            _escli = ebEscliUtils(_ebox)
            _result = _escli.mListFiles(_cell, aOptions=_options, aJson=True, aVault='@vaultA', aFilter={'redundancy': 'normal'})
        self.assertEqual(_result, [{'name': 'fileX'}])
        _node.mExecuteCmd.assert_called_once_with('/opt/oracle/cell/cellsrv/bin/escli --wallet /opt/oracle/cell/cellsrv/deploy/config/security/admwallet --ctrl 10.0.5.10:5052 --json ls @vaultA/ --filter redundancy=normal ')

    def test_mListFiles_json_parser_error(self):
        _ebox = self.mGetClubox()
        _cell = list(_ebox.mReturnCellNodes().keys())[0]
        _options = SimpleNamespace(jsonconf=None)
        _stdout = mock.MagicMock()
        ...
        _ctx.__enter__.return_value = _node
        _ctx.__exit__.return_value = None
        with mock.patch.object(ebEscliUtils, 'mParseExascaleAttrib', side_effect=Exception('missing')), mock.patch.object(ebEscliUtils, 'mGetCtrlIP', return_value=('10.0.6.10', 'fallback')), mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_ctx):
            with patch('exabox.ovm.csstep.exascale.escli_util.gExascaleError', {'EMPTY_ESCLI_OUTPUT': 'EMPTY'}, create=True), patch.object(_ebox, 'mUpdateErrorObject') as _update_error:
                _escli = ebEscliUtils(_ebox)
                with self.assertRaises(ExacloudRuntimeError):
                    _escli.mListFiles(_cell, aOptions=_options, aJson=True)
                _update_error.assert_called()
    ...
    def test_mGetERSEndpoint_fallback_ctrl_ip(self):
        ...
        _escli = ebEscliUtils(_ebox)
        _options = SimpleNamespace(jsonconf=None)
        with mock.patch.object(ebEscliUtils, 'mParseExascaleAttrib', side_effect=Exception('boom')), mock.patch.object(ebEscliUtils, 'mGetCtrlIP', return_value=('10.99.0.1', 'ctrl-host')) as _ctrl_mock:
            _ctrl_ip, _ctrl_port = _escli.mGetERSEndpoint(_options)
        self.assertEqual((_ctrl_ip, _ctrl_port), ('10.99.0.1', CTRL_PORT))
        _ctrl_mock.assert_called_once()

    def test_mCheckWalletExists_cell_missing(self):
        _ebox = self.mGetClubox()
        _escli = ebEscliUtils(_ebox)
        _options = SimpleNamespace(jsonconf={'exascale': {'ctrl_network': {'ip': '10.0.0.10', 'port': '5052'},
                                                         'host_nodes': [{'compute_hostname': 'dom0a'}],
                                                         'cell_list': ['cell1']}})

        _node = mock.MagicMock()
        _node.mExecuteCmd.return_value = (None, None, None)
        _node.mGetCmdExitStatus.return_value = 1
        _ctx = mock.MagicMock()
        _ctx.__enter__.return_value = _node
        _ctx.__exit__.return_value = None
        ...
        with mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_ctx):
            _rc = _escli.mCheckWalletExists('cell1', _options, aType='cell')

        self.assertEqual(_rc, 1)

    def test_mCheckWalletExists_dom0_missing(self):
        _ebox = self.mGetClubox()
        _escli = ebEscliUtils(_ebox)
        _options = SimpleNamespace(jsonconf={'exascale': {'ctrl_network': {'ip': '10.0.0.10', 'port': '5052'},
                                                         'host_nodes': [{'compute_hostname': 'dom0a'}],
        ...
        with mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_ctx):
            _rc = _escli.mCheckWalletExists('dom0a', _options, aType='dom0')
    ...
    def test_mGetEDVInitiator_error_raises(self):
        ...
        _context.__exit__.return_value = None
        with mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_context), mock.patch.object(_ebox, 'mUpdateErrorObject') as _error_mock:
            _escli = ebEscliUtils(_ebox)
            with self.assertRaises(ExacloudRuntimeError):
    ...
    def test_mCreateEDVVolume_error_propagates(self):
        ...
        _cell_list = _ebox.mReturnCellNodes()
        _cell = list(_cell_list.keys())[0]
        _options = SimpleNamespace(jsonconf={'exascale': {'ctrl_network': {'ip': '10.0.0.11', 'port': '5052'}, 'db_vault': {'name': 'vaultX'}}})
        _node = mock.MagicMock()
    ...
    def test_mGetACFSFileSystem_branch_lengths(self):
        ...
        _node = mock.MagicMock()
        _node.mExecuteCmd.side_effect = [(0, _stdout_len2, ''), (0, _stdout_len3, ''), (0, _stdout_len4, '')]
    ...
    def test_mRemoveFile_fallback_ctrl_config(self):
        ...
        with mock.patch.object(ebEscliUtils, 'mParseExascaleAttrib', side_effect=_raise_parse) as _parse_mock, mock.patch.object(ebEscliUtils, 'mGetDBVaultName', return_value='fallbackVault') as _vault_mock, mock.patch.object(ebEscliUtils, 'mGetCtrlIP', return_value=('10.1.0.3', 'ers')) as _ctrl_mock, mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_context):
            _escli = ebEscliUtils(_ebox)
    ...
    def test_mCreateVault_fallback_ctrl_ip(self):
        ...
        _cell = list(_cell_list.keys())[0]
        _options = SimpleNamespace(jsonconf=None)
        with mock.patch.object(ebEscliUtils, 'mGetCtrlIP', return_value=('10.1.0.4', 'ers')) as _ctrl_mock, mock.patch.object(ebEscliUtils, 'mExecuteEscliCmd', return_value=(0, '', '')) as _exec_mock:
            _escli = ebEscliUtils(_ebox)
        ...
        _exec_mock.assert_has_calls([mock.call(_cell, f'{ESCLI} --wallet {WALLET_LOC} --ctrl 10.1.0.4:{CTRL_PORT} --json mkvault @vaultX --provision-space-ef 20G'), mock.call(_cell, f'{ESCLI} --wallet {WALLET_LOC} --ctrl 10.1.0.4:{CTRL_PORT} --json mkvault @vaultX --provision-space-hc 20G')])
    ...
    def test_mGetProvisionedValue_fallback_ctrl(self):
        ...
        def _raise_parse(*_args, **_kwargs):
            raise Exception('fail')
        with mock.patch.object(ebEscliUtils, 'mParseExascaleAttrib', side_effect=_raise_parse), mock.patch.object(ebEscliUtils, 'mGetCtrlIP', return_value=('10.1.0.5', 'ers')) as _ctrl_mock, mock.patch.object(ebEscliUtils, 'mExecuteEscliCmd', return_value=(0, '', '')) as _exec_mock:
            _escli = ebEscliUtils(_ebox)
            _escli.mGetProvisionedValue(_cell, True, _options)
            _escli.mGetProvisionedValue(_cell, False, _options)
        self.assertEqual(_ctrl_mock.call_count, 2)
        _exec_mock.assert_has_calls([mock.call(_cell, f'{ESCLI} --wallet {WALLET_LOC} --ctrl 10.1.0.5:{CTRL_PORT} --json  lsvault *xsvlt-* --attributes spaceProvEF'), mock.call(_cell, f'{ESCLI} --wallet {WALLET_LOC} --ctrl 10.1.0.5:{CTRL_PORT} --json  lsvault *xsvlt-* --attributes spaceProvHC')])
    ...
    def test_mChangeVault_fallback_ctrl_ip(self):
        ...
        def _raise_parse(*_args, **_kwargs):
            raise Exception('fail')
        with mock.patch.object(ebEscliUtils, 'mParseExascaleAttrib', side_effect=_raise_parse), mock.patch.object(ebEscliUtils, 'mGetCtrlIP', return_value=('10.1.0.4', 'ers')) as _ctrl_mock, mock.patch.object(ebEscliUtils, 'mExecuteEscliCmd', return_value=(0, '', '')) as _exec_mock:
            _escli = ebEscliUtils(_ebox)
        ...
        with mock.patch.object(ebEscliUtils, 'mParseExascaleAttrib', side_effect=_raise_parse), mock.patch.object(ebEscliUtils, 'mGetCtrlIP', return_value=('10.1.0.4', 'ers')) as _ctrl_mock2, mock.patch.object(ebEscliUtils, 'mExecuteEscliCmd', return_value=(0, '', '')) as _exec_mock2:
            _escli = ebEscliUtils(_ebox)
    ...
    def test_mCreateEDVVolumeAttachment_error_path(self):
        ...
        def _raise_parse(*_args, **_kwargs):
            raise Exception('fail')
        with mock.patch.object(ebEscliUtils, 'mParseExascaleAttrib', side_effect=_raise_parse), mock.patch.object(ebEscliUtils, 'mGetCtrlIP', return_value=('10.1.0.6', 'ers')) as _ctrl_mock, mock.patch.object(ebEscliUtils, 'mExecuteEscliCmd', return_value=(0, '', '')) as _exec_mock:
            _escli = ebEscliUtils(_ebox)
            _escli.mChangeVault(_cell, True, 'vaultY', '30', _options)
            _escli.mChangeVault(_cell, False, 'vaultY', '30', _options)
        self.assertEqual(_ctrl_mock.call_count, 2)
        _exec_mock.assert_has_calls([mock.call(_cell, f'{ESCLI} --wallet {WALLET_LOC} --ctrl 10.1.0.6:{CTRL_PORT} --json chvault @vaultY --attributes spaceProvEF=30G'), mock.call(_cell, f'{ESCLI} --wallet {WALLET_LOC} --ctrl 10.1.0.6:{CTRL_PORT} --json chvault @vaultY --attributes spaceProvHC=30G')])

    def test_mGetByPath_and_mParseEscliJson_branches(self):
        _ebox = self.mGetClubox()
        _escli = ebEscliUtils(_ebox)
        _payload = {'data': ['skip-me', {'id': 'first', 'attributes': {'hostName': 'host-a', 'state': 'offline'}}, {'id': 'second', 'attributes': {'hostName': 'host-b', 'state': 'online'}}]}
        ...
        _result = _escli.mParseEscliJson(_payload, match_dict={'attributes.hostName': lambda _value: _value == 'host-b', 'attributes.state': 'online'}, return_keys=['id', 'attributes.hostName'])
    ...
    def test_mGetDictFromOutputString_paths(self):
        ...
        self.assertEqual(_escli.mGetDictFromOutputString(_valid_out, 'escli --json lsuser', _ebox), {'data': [{'id': 'ok'}]})
    ...
    def test_mGetUser_fallback_and_no_match(self):
        ...
        _context.__enter__.return_value = _node
        _context.__exit__.return_value = None
        with mock.patch.object(ebEscliUtils, 'mParseExascaleAttrib', side_effect=Exception('missing ctrl')), mock.patch.object(ebEscliUtils, 'mGetCtrlIP', return_value=('10.2.0.1', 'ers-host')) as _ctrl_mock, mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_context):
            _escli = ebEscliUtils(_ebox)
            _user = _escli.mGetUser(_cell, 'cluster-a', _options)
        self.assertEqual(_user, '')
        _ctrl_mock.assert_called_once()
        _node.mExecuteCmd.assert_called_once_with(f'{ESCLI} --wallet {WALLET_LOC} --ctrl 10.2.0.1:{CTRL_PORT} --json lsuser')
    ...
    def test_mGetClusterID_returns_empty_cluster_id_when_user_missing(self):
        ...
        _options = SimpleNamespace(jsonconf=None)
        _stdout = mock.MagicMock()
        _stdout.read.return_value = '{"data":[{"attributes":{"giClusterName":"%s","giClusterId":"cluster-id-1"}}]}' % _ebox.mGetClusters().mGetCluster().mGetCluName()
        _node = mock.MagicMock()
        _node.mExecuteCmd.return_value = (0, _stdout, '')
        _node.mGetCmdExitStatus.return_value = 0
        _context = mock.MagicMock()
        _context.__enter__.return_value = _node
        _context.__exit__.return_value = None
        with mock.patch.object(ebEscliUtils, 'mParseExascaleAttrib', side_effect=Exception('missing ctrl')), mock.patch.object(ebEscliUtils, 'mGetCtrlIP', return_value=('10.2.0.2', 'ers-host')) as _ctrl_mock, mock.patch.object(ebEscliUtils, 'mGetUser', return_value='') as _get_user_mock, mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_context):
            _escli = ebEscliUtils(_ebox)
    ...
    def test_mCreateEsWalletUser_acl_json_parse_error(self):
        ...
        _cell_list = _ebox.mReturnCellNodes()
        _cell = list(_cell_list.keys())[0]
        _options = SimpleNamespace(jsonconf={'exascale': {'ctrl_network': {'ip': '10.0.0.31', 'port': '5052'}}})
        _mk_stdout = mock.MagicMock()
        _mk_stdout.readlines.return_value = []
        _lsacl_stdout = mock.MagicMock()
        ...
        _context.__enter__.return_value = _mock_node
        _context.__exit__.return_value = None
        with mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_context), mock.patch('exabox.ovm.csstep.exascale.escli_util.node_exec_cmd_check') as _exec_check_mock, mock.patch.object(_ebox, 'mUpdateErrorObject') as _error_mock:
            _escli = ebEscliUtils(_ebox)
            with self.assertRaises(ExacloudRuntimeError):
    ...
    def test_mGetEDVInitiator_fallback_no_match(self):
        ...
        _context.__enter__.return_value = _node
        _context.__exit__.return_value = None
        with mock.patch.object(ebEscliUtils, 'mParseExascaleAttrib', side_effect=Exception('missing ctrl')), mock.patch.object(ebEscliUtils, 'mGetCtrlIP', return_value=('10.3.0.1', 'ers')) as _ctrl_mock, mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_context):
            _escli = ebEscliUtils(_ebox)
    ...
    def test_mGetVolumeID_fallback_and_error_paths(self):
        ...
        with mock.patch.object(ebEscliUtils, 'mParseExascaleAttrib', side_effect=Exception('missing ctrl')), mock.patch.object(ebEscliUtils, 'mGetCtrlIP', return_value=('10.3.0.2', 'ers')) as _ctrl_mock, mock.patch.object(ebEscliUtils, 'mGetDBVaultName', return_value='vaultFallback') as _vault_mock, mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_context_ok):
            _escli = ebEscliUtils(_ebox)
        ...
        with mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_context_err), mock.patch.object(_ebox, 'mUpdateErrorObject') as _error_mock:
            _escli = ebEscliUtils(_ebox)
            with self.assertRaises(ExacloudRuntimeError):
    ...
    def test_mGetVolumeAttachments_fallback_no_match(self):
        ...
        _context.__enter__.return_value = _node
        _context.__exit__.return_value = None
        with mock.patch.object(ebEscliUtils, 'mParseExascaleAttrib', side_effect=Exception('missing ctrl')), mock.patch.object(ebEscliUtils, 'mGetCtrlIP', return_value=('10.3.0.3', 'ers')) as _ctrl_mock, mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_context):
            _escli = ebEscliUtils(_ebox)
    ...
    def test_mGetACFSFileSystem_fallback_error_path(self):
        ...
        _context.__enter__.return_value = _node
        _context.__exit__.return_value = None
        with mock.patch.object(ebEscliUtils, 'mParseExascaleAttrib', side_effect=Exception('missing ctrl')), mock.patch.object(ebEscliUtils, 'mGetCtrlIP', return_value=('10.3.0.4', 'ers')) as _ctrl_mock, mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_context), mock.patch.object(_ebox, 'mUpdateErrorObject') as _error_mock:
            _escli = ebEscliUtils(_ebox)
            with self.assertRaises(ExacloudRuntimeError):
    ...
    def test_mGetACFSFileSystemByJsonFormat_fallback_executes(self):
        ...
        _cell = list(_ebox.mReturnCellNodes().keys())[0]
        _options = SimpleNamespace(jsonconf=None)
        with mock.patch.object(ebEscliUtils, 'mParseExascaleAttrib', side_effect=Exception('missing ctrl')), mock.patch.object(ebEscliUtils, 'mGetCtrlIP', return_value=('10.3.0.5', 'ers')) as _ctrl_mock, mock.patch.object(ebEscliUtils, 'mExecuteEscliCmd', return_value=(0, '{}', '')) as _exec_mock:
            _escli = ebEscliUtils(_ebox)
            self.assertEqual(_escli.mGetACFSFileSystemByJsonFormat(_cell, _options), (0, '{}', ''))
        _ctrl_mock.assert_called_once()
        _exec_mock.assert_called_once_with(_cell, f'{ESCLI} --wallet {WALLET_LOC} --ctrl 10.3.0.5:{CTRL_PORT} --json lsacfsfilesystem --attributes id,volume,mountPath,size,totalFree')

    def test_mChangeACL_fallback_paths(self):
        _ebox = self.mGetClubox()
        _cell = list(_ebox.mReturnCellNodes().keys())[0]
        _options = SimpleNamespace(jsonconf=None)
        with mock.patch.object(ebEscliUtils, 'mParseExascaleAttrib', side_effect=Exception('missing ctrl')), mock.patch.object(ebEscliUtils, 'mGetDBVaultName', return_value='vaultFallback') as _vault_mock, mock.patch.object(ebEscliUtils, 'mGetCtrlIP', return_value=('10.3.0.6', 'ers')) as _ctrl_mock, mock.patch.object(ebEscliUtils, 'mGetDBServerStatus', return_value=(2, '')) as _status_mock:
            _escli = ebEscliUtils(_ebox)
            self.assertIsNone(_escli.mChangeACL(_cell, 'clusterA', 'read', _options, aHost='host1.example.com', aVaultName='vaultCustom'))
        _vault_mock.assert_not_called()
        _ctrl_mock.assert_called_once()
        ...
        _context.__enter__.return_value = _node
        _context.__exit__.return_value = None
        with mock.patch.object(ebEscliUtils, 'mParseExascaleAttrib', side_effect=Exception('missing ctrl')), mock.patch.object(ebEscliUtils, 'mGetDBVaultName', return_value='vaultFallback'), mock.patch.object(ebEscliUtils, 'mGetCtrlIP', return_value=('10.3.0.7', 'ers')), mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_context), mock.patch.object(_ebox, 'mUpdateErrorObject') as _error_mock:
            _escli = ebEscliUtils(_ebox)
            with self.assertRaises(ExacloudRuntimeError):
                _escli.mChangeACL(_cell, 'clusterA', 'read', _options)
        _node.mExecuteCmdLog.assert_called_once_with(f'{ESCLI} --wallet {WALLET_LOC} --ctrl 10.3.0.7:{CTRL_PORT} chacl @vaultFallback +clusterA:read')
        _error_mock.assert_called_once()
    ...
    def test_wrapper_fallback_commands(self):
        ...
        _context.__enter__.return_value = _node
        _context.__exit__.return_value = None
        with mock.patch.object(ebEscliUtils, 'mParseExascaleAttrib', side_effect=Exception('missing ctrl')), mock.patch.object(ebEscliUtils, 'mGetCtrlIP', return_value=('10.3.0.8', 'ers')), mock.patch.object(ebEscliUtils, 'mGetDBVaultName', return_value='vaultFallback'), mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_context), mock.patch.object(_ebox, 'mUpdateErrorObject') as _error_mock:
            _escli = ebEscliUtils(_ebox)
    ...
    def test_fallback_execute_wrappers(self):
        ...
        _context.__enter__.return_value = _node
        _context.__exit__.return_value = None
        with mock.patch.object(ebEscliUtils, 'mParseExascaleAttrib', side_effect=Exception('missing ctrl')), mock.patch.object(ebEscliUtils, 'mGetDBVaultName', return_value='vaultFallback'), mock.patch.object(ebEscliUtils, 'mGetCtrlIP', return_value=('10.3.0.9', 'ers')) as _ctrl_mock, mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_context), mock.patch.object(ebEscliUtils, 'mExecuteEscliCmd', side_effect=[(0, '', ''), (0, 'vault-out', ''), (0, 'rmvault-out', ''), (0, 'pool-out', ''), (0, 'curr-out', ''), (0, 'reconfig-out', ''), (0, 'cluster-out', '')]) as _exec_mock:
            _escli = ebEscliUtils(_ebox)
        ...
        self.assertEqual(
            _exec_mock.call_args_list[6][0],
            (_cell, f'{ESCLI} --wallet {WALLET_LOC} --ctrl 10.3.0.9:{CTRL_PORT} lscluster --attributes autoFileEncryption')
        )
    ...
    def test_mCreateEDVVolumeAttachment_ctrl_lookup_failure(self):
        ...
        _cell = list(_ebox.mReturnCellNodes().keys())[0]
        _options = SimpleNamespace(jsonconf=None)
        with mock.patch.object(ebEscliUtils, 'mParseExascaleAttrib', side_effect=Exception('missing ctrl')), mock.patch.object(ebEscliUtils, 'mGetCtrlIP', side_effect=Exception('lookup failed')):
            _escli = ebEscliUtils(_ebox)
    ...
    def test_mGetUser_result_without_id_returns_empty(self):
        ...
        _context.__enter__.return_value = _node
        _context.__exit__.return_value = None
        with mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_context), mock.patch.object(ebEscliUtils, 'mGetDictFromOutputString', return_value={'data': [{'id': 'gridcluster-a'}]}), mock.patch.object(ebEscliUtils, 'mParseEscliJson', return_value={'hostName': 'cluster-a'}):
            _escli = ebEscliUtils(_ebox)
    ...
    def test_mResizeEDVVolume_fallback_success(self):
        ...
        _context.__enter__.return_value = _node
        _context.__exit__.return_value = None
        with mock.patch.object(ebEscliUtils, 'mParseExascaleAttrib', side_effect=Exception('missing ctrl')), mock.patch.object(ebEscliUtils, 'mGetCtrlIP', return_value=('10.3.1.1', 'ers')) as _ctrl_mock, mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_context):
            _escli = ebEscliUtils(_ebox)
            self.assertEqual(_escli.mResizeEDVVolume(_cell, '120G', 'vol-fallback', _options), 0)
        _ctrl_mock.assert_called_once()
        _node.mExecuteCmdLog.assert_called_once_with(f'{ESCLI} --wallet {WALLET_LOC} --ctrl 10.3.1.1:{CTRL_PORT} chvolume vol-fallback --attributes size=120G')
    ...
    def test_mCreateEDVVolumeAttachment_fallback_success(self):
        ...
        _context.__enter__.return_value = _node
        _context.__exit__.return_value = None
        with mock.patch.object(ebEscliUtils, 'mParseExascaleAttrib', side_effect=Exception('missing ctrl')), mock.patch.object(ebEscliUtils, 'mGetCtrlIP', return_value=('10.3.1.2', 'ers')) as _ctrl_mock, mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_context):
            _escli = ebEscliUtils(_ebox)
            self.assertEqual(_escli.mCreateEDVVolumeAttachment(_cell, 'vol-fallback', 'dev1', 'cluster-id', 'griduser', _options, aInitiatorID='init-1'), 0)
        _ctrl_mock.assert_called_once()
        _node.mExecuteCmdLog.assert_called_once_with(f'{ESCLI} --wallet {WALLET_LOC} --ctrl 10.3.1.2:{CTRL_PORT} mkvolumeattachment --protocol edv vol-fallback dev1 --initiator init-1 --attributes user=griduser')
    ...
    def test_mRemoveACFSFileSystem_fallback_force_retry(self):
        ...
        _context.__enter__.return_value = _node
        _context.__exit__.return_value = None
        with mock.patch.object(ebEscliUtils, 'mParseExascaleAttrib', side_effect=Exception('missing ctrl')), mock.patch.object(ebEscliUtils, 'mGetCtrlIP', return_value=('10.3.1.3', 'ers')) as _ctrl_mock, mock.patch('exabox.ovm.csstep.exascale.escli_util.connect_to_host', return_value=_context):
            _escli = ebEscliUtils(_ebox)
