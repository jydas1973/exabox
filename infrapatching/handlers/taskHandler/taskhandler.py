#
# $Header: ecs/exacloud/exabox/infrapatching/handlers/taskHandler/taskhandler.py /main/24 2025/04/10 04:18:30 antamil Exp $
#
# taskhandler.py
#
...
#
#    NAME
#      taskhandler.py - Place holder for common functionalities among exadata
#      tasks.
#
#    DESCRIPTION
...
#
#    MODIFIED   (MM/DD/YY)
#    abflores    03/11/25 - Bug 37669225: FIX NONE OBJECT FOUND WHILE
#                           PERFORMING DOMU PATCHING
...
class TaskHandler(GenericHandler):

    def __init__(self, *initial_data, **kwargs):
        __metaclass__ = abc.ABCMeta
        super(TaskHandler, self).__init__(*initial_data, **kwargs)
        self.mPatchLogInfo("TaskHandler")
    ...
    def mAcquireLock(self):
        ...
        if self.mGetFabric():
            ...
            self.mPatchLogWarn("ibfabric not found, AcquireLock was skipped")
    ...
    def mReleaseLock(self):
        if self.mGetFabric():
            ...
            self.mPatchLogWarn("ibfabric not found, ReleaseLock was skipped")
    ...
    def mExecuteTask(self):
        ...
        try:
            ...
            for _current_handler in INFRA_PATCHING_HANDLERS.values():
                if _current_handler and isinstance(_current_handler,TargetHandler):
            ...
            if self.mGetInfrapatchExecutionValidator().mCheckCondition('mIsPatchBaseMarkerFileApplicable'):
                if _context_target_handler and isinstance(_context_target_handler,DomUHandler) :
