#
# $Header: ecs/exacloud/exabox/infrapatching/handlers/taskHandler/patchhandler.py /main/13 2024/09/24 16:45:50 araghave Exp $
#
# patchhandler.py
#
...
#
#    NAME
#      patchhandler.py - Wrapper Patching API to expose patch operation
#
#    DESCRIPTION
...
class PatchHandler(TaskHandler):

    def __init__(self, *initial_data, **kwargs):
        super(PatchHandler, self).__init__(*initial_data, **kwargs)
        self.mPatchLogInfo("PatchHandler")
