#
# $Header: ecs/exacloud/exabox/infrapatching/handlers/taskHandler/rollbackhandler.py /main/13 2024/09/24 16:45:50 araghave Exp $
#
# rollbackhandler.py
#
...
#
#    NAME
#      rollbackhandler.py - Wrapper Patching API to expose rollback operation
#
#    DESCRIPTION
...
class RollBackHandler(TaskHandler):
    ...
    def __init__(self, *initial_data, **kwargs):
        super(RollBackHandler, self).__init__(*initial_data, **kwargs)
        mRegisterInfraPatchingHandlers(INFRA_PATCHING_HANDLERS, [TASK_ROLLBACK], self)
        self.mPatchLogInfo("RollBackHandler")
