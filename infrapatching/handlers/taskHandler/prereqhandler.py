#
# $Header: ecs/exacloud/exabox/infrapatching/handlers/taskHandler/prereqhandler.py /main/13 2024/09/24 16:45:50 araghave Exp $
#
# prereqhandler.py
#
...
#
#    NAME
#      prereqhandler.py - Wrapper Patching API to expose patch prereq operation
#
#    DESCRIPTION
...
class PreReqHandler(TaskHandler):

    def __init__(self, *initial_data, **kwargs):
        super(PreReqHandler, self).__init__(*initial_data, **kwargs)
        mRegisterInfraPatchingHandlers(INFRA_PATCHING_HANDLERS, [TASK_PREREQ_CHECK], self)
        self.mPatchLogInfo("PreReqHandler")
