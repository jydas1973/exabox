#
# $Header: ecs/exacloud/exabox/infrapatching/handlers/mockTaskHandler/postcheckmockhandler.py /main/2 2024/11/04 07:22:22 emekala Exp $
#
# postcheckmockhandler.py
#
# Copyright (c) 2020, 2024, Oracle and/or its affiliates.
#
#    NAME
#      postcheckmockhandler.py- Wrapper Patching API to expose rollback
#      prereq operation
#
#    DESCRIPTION
...
class PostCheckMockHandler(TaskMockHandler):

    def __init__(self, *initial_data, **kwargs):
        super(PostCheckMockHandler, self).__init__(*initial_data, **kwargs)
        mRegisterInfraPatchingHandlers(INFRA_PATCHING_HANDLERS, [TASK_POSTCHECK], self)
        self.mPatchLogInfo("PostCheckMockHandler")
