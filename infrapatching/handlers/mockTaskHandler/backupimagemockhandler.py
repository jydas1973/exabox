#
# $Header: ecs/exacloud/exabox/infrapatching/handlers/mockTaskHandler/backupimagemockhandler.py /main/2 2024/11/04 07:22:22 emekala Exp $
#
# backupimagemockhandler.py
#
# Copyright (c) 2020, 2024, Oracle and/or its affiliates.
#
#    NAME
#      backupimagemockhandler.py - Wrapper Patching API to expose backup image
#      operation
#
#    DESCRIPTION
...
class BackupImageMockHandler(TaskMockHandler):

    def __init__(self, *initial_data, **kwargs):
        super(BackupImageMockHandler, self).__init__(*initial_data, **kwargs)
        mRegisterInfraPatchingHandlers(INFRA_PATCHING_HANDLERS, [TASK_BACKUP_IMAGE], self)
        self.mPatchLogInfo("BackupImageMockHandler")
